...
export const SectionContainer = styled.div `
    ...
    &:before {
        ...
        ${prpops => prpops.mode === "signup" ? "transform: translate(100%,-50%); right: 52%;" : null };
        ...
        @media only screen and (max-width: 870px){
            ...
            ${prpops => prpops.mode === "signup" ? "transform: translate(-50%,100%); bottom: 32%; right: initial;" : null };
            
            @media only screen and (max-width: 870px) {
                ${prpops => prpops.mode === "signup" ? "transform: translate(-50%,100%); bottom: 25%; right: initial;" : null };
            }
            @media only screen and (max-width: 500px) {
                ${prpops => prpops.mode === "signup" ? "transform: translate(-50%,100%); bottom: 30%; right: initial;" : null };
            }
        }
    }
`;
...
export const SignInSignUp = styled.div `
    ...
    @media only screen and (max-width: 870px){
        ...
        ${props => props.mode === "signup" ? "top: 5%; transform: translate(-50%,0);" : null};
    }

    @media only screen and (max-width: 500px){
        ${props => props.mode === "signup" ? "top: 0%; transform: translate(-50%,0);" : null};
    }
...
export const LeftPannelsContainer = styled.div `
    ...
    & ${ContentContainer}, & ${ImageContainer} {
        ${props => props.mode === "signup" ? "transform: translateX(-800px)" : null};
    }
    ...
    @media only screen and (max-width: 870px){
        ...
        & ${ContentContainer}, & ${ImageContainer} {
            ${props => props.mode === "signup" ? "transform: translateY(-300px)" : null};
        }
    }
...
export const RightPannelsContainer = styled.div `
    ...
    & ${ContentContainer}, & ${ImageContainer} {
        ...
        ${props => props.mode === "signup" ? "transform: translateX(0px)" : null};
